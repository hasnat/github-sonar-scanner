...
RUN apk update \
  ...
  && wget -q https://sonarsource.bintray.com/Distribution/sonar-scanner-cli/sonar-scanner-cli-${SONAR_SCANNER_VERSION}.zip \
  && unzip sonar-scanner-cli-${SONAR_SCANNER_VERSION}.zip \
  && mv /usr/src/myapp/sonar-scanner-${SONAR_SCANNER_VERSION}/lib/sonar-scanner-cli-${SONAR_SCANNER_VERSION}.jar \
     /usr/src/myapp/sonar-scanner-${SONAR_SCANNER_VERSION}/lib/sonar-scanner-cli.jar
